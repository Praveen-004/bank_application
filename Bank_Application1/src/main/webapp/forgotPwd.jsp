...
<form class="form" action="forgot" method="post">
        ...
        <label>
            <input class="input" type="password" placeholder="" required name="ps1">
            <span>Password</span>
        </label>
        <label>
            <input class="input" type="password" placeholder="" required name="ps2">
            <span>Confirm password</span>
        </label>
        <button class="submit">Submit</button>
        <p class="signin">Go To Sign In ? <a href="login.jsp">SignIn</a></p>
    </form>
</body>
</html>